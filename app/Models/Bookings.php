...
class Bookings extends Model
{
	...
	/**
	 * To update the new booking into existing bookings
	 *
	 * @param array $newBooking
	 * @return boolean
	 */
	public static function setNewBooking(array $newBooking): bool
	{
		return Redis::set( Bookings::CACHE_KEY, json_encode( $newBooking ) );
	}
}
